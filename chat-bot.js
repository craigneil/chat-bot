  ...
  function r() {
                    ...
                    if ((r || (a = 'next'), (n = i[a]))) {
                      ...
                      1 === r && (n = i.return) && n.call(i),
                        r < 2 &&
                          ...
                          (r = 1));
                    i = e;
                  } else if ((n = (m = p.n < 0) ? c : t.call(o, p)) !== l)
                    break;
                } catch (n) {
                  (i = e), (r = 1), (c = n);
                } finally {
    ...
    var p = [][o]
        ...
        : (c((n = {}), o, function () {
          ...
          n),
      u = (m.prototype = d.prototype = Object.create(p));
    function f(e) {
      return (
            ...
            for (;;)
              switch (e.n) {
                case 0:
                  return (
                    (i = { agent_id: n }),
                    'number' != typeof o || isNaN(o) || (i.agent_version = o),
                    a &&
                      Object.keys(a).length > 0 &&
                      (i.retell_llm_dynamic_variables = a),
                    (e.n = 1),
                ...
                case 1:
                  ...
                  return (c = 'Unknown error'), (e.p = 2), (e.n = 3), l.json();
                case 3:
                  (d = e.v), (c = d.message || c), (e.n = 5);
                  break;
                case 4:
                  (e.p = 4), e.v;
                case 5:
                  return e.a(2, { status: 'error', message: c });
                case 6:
                  return (e.n = 7), l.json();
                case 7:
                  return e.a(2, e.v);
            ...
            function (e) {
              for (;;)
                switch (e.n) {
                  case 0:
                    return (
                      (i = u.length > 4 && void 0 !== u[4] ? u[4] : null),
                      (l = u.length > 5 && void 0 !== u[5] ? u[5] : null),
                      (c = u.length > 6 && void 0 !== u[6] ? u[6] : null),
                      (d = { from_number: n, to_number: t }),
                      (a = u.length > 3 && void 0 !== u[3] ? u[3] : null) &&
                        (d.override_agent_id = a),
                      i && (d.override_agent_version = i),
                      l && (d.metadata = l),
                      c &&
                        Object.keys(c).length > 0 &&
                        (d.retell_llm_dynamic_variables = c),
                      (e.n = 1),
                  ...
                  case 1:
                    ...
                    return (
                      (m = 'Unknown error'), (e.p = 2), (e.n = 3), s.json()
                    );
                  case 3:
                    (p = e.v), (m = p.message || m), (e.n = 5);
                    break;
                  case 4:
                    (e.p = 4), e.v;
                  case 5:
                    return e.a(2, { status: 'error', message: m });
                  case 6:
                    return (e.n = 7), s.json();
                  case 7:
                    return e.a(2, e.v);
    ...
    function p(e) {
      return (
        Object.setPrototypeOf
          ...
          : ((e.__proto__ = d), B(e, a, 'GeneratorFunction')),
  ...
  !(function () {
    function t() {
        ...
        if (o) {
          ...
          if ('callback' !== c || d) {
            var s = t.getAttribute('data-agent-version'),
              p = s ? parseInt(s, 10) : void 0,
              f = t.getAttribute('data-color') || '#0d1123',
              b = t.getAttribute('data-logo-url'),
              y = t.getAttribute('data-tc'),
              v = t.getAttribute('data-countries'),
              C =
            ...
            var I = t.getAttribute('data-dynamic'),
              B = {};
            if (I)
              try {
                B = JSON.parse(I);
            ...
            var L,
              E = 'true' === t.getAttribute('data-auto-open'),
              N = t.getAttribute('data-popup-message'),
              z = t.getAttribute('data-bot-name'),
              O = t.getAttribute('data-show-ai-popup-time'),
              G = O ? parseInt(O, 10) : 0,
              P = E,
              H = N && !E,
              F = localStorage.getItem('LS_CHAT_ID') || null,
              R = JSON.parse(localStorage.getItem('LS_CHAT_HISTORY') || '[]'),
              V = JSON.parse(localStorage.getItem('LS_CHAT_LIST') || '[]'),
              D = null,
              Z = (function (e) {
                var t = e.robotSVG,
                  o = e.hamburgerSVG,
                ...
                T(
                  T(
                    T(
                      T(
                        {
                          ...
                          onHamburger: function () {
                            ae(), (Y.style.display = 'flex');
                          },
                          onSidebarClose: function () {
                            Y.style.display = 'none';
                          },
                          onSidebarItemClick: re,
                          onModalYes: function () {
                      ...
                      y ? { termsAndConditionsUrl: y } : {}
                    ),
                    v ? { countriesFilter: v } : {}
                  ),
                  {},
                  { popupMessage: N, botName: z }
                )
              ),
              K = Z.shadow,
              U = Z.chat,
              ...
              $ = Z.focusInput,
              ee = Z.aiMessageModal,
              ne = Z.aiMessageContent,
              te = Z.aiMessageBotName;
            Z.aiMessageClose,
              Z.callbackForm,
              Z.firstNameInput,
              Z.lastNameInput,
                  ...
                  for (;;)
                    switch (e.n) {
                      case 0:
                        ...
                        return (U.style.display = 'none'), (e.n = 1), ie();
                      case 1:
                        return e.a(2);
                    }
                }, e);
              ...
              function (e) {
                for (;;)
                  switch (e.n) {
                    case 0:
                      if (
                        ('none' !== ee.style.display &&
                          (ee.style.display = 'none'),
                        D && (clearTimeout(D), (D = null)),
                        'flex' !== U.style.display)
                      ) {
                        e.n = 1;
                        break;
                      }
                      (U.style.display = 'none'), (e.n = 12);
                      break;
                    case 1:
                      if ('callback' !== c) {
                        e.n = 2;
                      ...
                      return (U.style.display = 'flex'), e.a(2);
                    case 2:
                      if (((n = V[0]), (t = !1), !n)) {
                        e.n = 6;
                        break;
                    ...
                    case 9:
                      (l = e.v).messages &&
                        ...
                        (l.messages
                          ...
                          .forEach(function (e) {
                            R.push({ role: 'agent', content: e.content });
                          }),
                        oe(),
                        w(R),
                        -1 !==
                          (r = V.findIndex(function (e) {
                            return e.id === F;
                          })) &&
                          ((V[r].history = R),
                          (V[r].date = new Date().toISOString()),
                          j(V))),
            ...
            return M().w(
              function (e) {
                for (;;)
                  switch (e.n) {
                    case 0:
                      return (F = n), (t = !1), (e.p = 1), (e.n = 2), u(F, o);
                    case 2:
      ...
      function me() {
        return (me = A(
          M().m(function e(n) {
            var t, i, l, r, c, s, m, u, f, g, b, h, y, v, w, j, _, k;
            return M().w(
              function (e) {
                for (;;)
                  switch (e.n) {
                    ...
                    case 3:
                      if ('error' !== (y = e.v).status) {
                        e.n = 4;
                        break;
                      }
                      throw new Error(
                        y.message || 'Failed to submit call request'
                      );
                    case 4:
                      if (y.call_id) {
                        e.n = 5;
      ...
      function ye() {
        return (ye = A(
          M().m(function e(n) {
            var t, a, i, l, r, c, d, s, m, p, u;
            return M().w(
              function (e) {
                for (;;)
                  switch (e.n) {
                    case 0:
                      if ((n.preventDefault(), (a = W.value.trim()))) {
                        e.n = 1;
                        break;
                      }
                      return e.a(2);
                    ...
                    case 7:
                      -1 !==
                        (c = V.findIndex(function (e) {
                          return e.id === F;
                        })) &&
                        R.length > 0 &&
                        ((d = R[R.length - 1].content).length > 40 &&
                          (d = d.slice(0, 40) + '...'),
                        (V[c].title = d),
                        (V[c].history = R),
                        (V[c].date = new Date().toISOString()),
                        (s = V.splice(c, 1)),
                        (m = S(s, 1)),
                        (p = m[0]),
                        V.unshift(p),
